...
var MsgFlags = map[int]string{
	...
	ERROR_ADD_SHIPPING:                        "添加收货地址失败",
	ERROR_UPDATE_SHIPPING:                     "更新收货地址失败",
	ERROR_DELETE_SHIPPING:                     "删除收货地址失败",
	ERROR_GET_SHIPPING:                        "获取收货地址失败",
	ERROR_GET_SHIPPINGS:                       "获取收货地址列表失败",
	ERROR_NOT_EXIST_SHIPPING:                  "收货地址不存在",
	ERROR_PRODUCT_OFFSALE_OR_DELETED:          "商品已下架或已被删除",
	ERROR_ORDER_PAY:                           "支付宝生成订单失败",
	ERROR_NOT_EXIST_ORDER:                     "订单不存在",
	ERROR_GET_ORDER:                           "查询订单失败",
	ERROR_QUERY_ORDER_PAY_STATUS:              "查询订单支付状态失败",
	ERROR_ALIPAY_CALLBACK_REPEAT:              "支付宝回调重复",
	ERROR_UPDATE_ORDER_STATUS:                 "更新订单状态失败",
	ERROR_CREATE_PAYINFO:                      "创建支付信息失败",
	ERROR_CREATE_ORDER:                        "创建订单失败",
	ERROR_CANCEL_ORDER:                        "取消订单失败",
	ERROR_GET_ORDER_CART_PRODUCT:              "获取订单的商品信息失败",
	ERROR_GET_ORDER_LIST:                      "获取订单列表失败",
	ERROR_GET_ORDER_DETAIL:                    "获取订单详情失败",
	ERROR_SEND_GOODS:                          "更新发货状态失败",
